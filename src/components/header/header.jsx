...
const Header = () => {
  ...
  const menuItems = [
    { id: 1, text: 'About', href: '#home' },
    { id: 2, text: 'Services', href: '#about' },
    { id: 3, text: 'Why Us', href: '#services' },
    { id: 4, text: 'Work', href: '#portfolio' },
    { id: 5, text: 'Approach', href: '#contact' }
  ];

  return (
    <>
      {/* Header */}
      <header className="fixed main-header left-0 right-0 flex justify-between items-center px-10 bg-white backdrop-blur-[10px] z-[1000]">
        <div className="logo">
          <img 

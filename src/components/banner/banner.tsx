    ...
    <section className="banner">
      ...
      >
        ...
        <div className={`banner-buttons ${isAnimated ? 'animate-in animate-delay-3' : ''}`}>
          <a href="#contact" className="btn btn-primary" onClick={(e) => onSmoothScroll(e, '#contact')}>
            <span>Start Your Project</span>
          </a>
          <a href="#services" className="btn btn-secondary" onClick={(e) => onSmoothScroll(e, '#services')}>
